...
export const ZONES: Zone[] = [
    ...
    },
    {
        ...
        tasks: [
            ...
            new TaskDefinition({ id: 217, name: "Griffin", type: TaskType.Boss, cost_multiplier: 20_000_000_000_000, xp_mult: 0.001, skills: [SkillType.Combat], item: ItemType.GriffinQuill, unlocks_task: 218 }),
    ...
    },
    {
        ...
        tasks: [
            ...
            new TaskDefinition({ id: 227, name: "Winged Demon", type: TaskType.Boss, cost_multiplier: 1_500_000_000_000_000, xp_mult: 0.0002, skills: [SkillType.Combat], item: ItemType.WingsOfShadow, unlocks_task: 228 }),
    ...
    },
    {
        ...
        tasks: [
            ...
            new TaskDefinition({ id: 237, name: "PLACEHOLDER", type: TaskType.Boss, cost_multiplier: 6_000_000_000_000_000, xp_mult: 0.0001, skills: [SkillType.Combat], item: ItemType.DragonScale, unlocks_task: 238 }),
    ...
    },
    {
        ...
        tasks: [
            new TaskDefinition({ id: 240, name: "Journey Into the Depths", type: TaskType.Travel, cost_multiplier: 7000, skills: [SkillType.Travel] }),
            new TaskDefinition({ id: 241, name: "Determine Deepest Point", type: TaskType.Mandatory, cost_multiplier: 100_000_000_000, max_reps: 1, skills: [SkillType.Search, SkillType.Study], xp_mult: 0.0001 }),
            new TaskDefinition({ id: 242, name: "Prepare for the Pressure", type: TaskType.Mandatory, cost_multiplier: 80_000_000_000, max_reps: 3, skills: [SkillType.Fortitude], xp_mult: 0.000001 }),
            ...
            new TaskDefinition({ id: 247, name: "Half-Kraken", type: TaskType.Boss, cost_multiplier: 9_000_000_000_000_000, xp_mult: 0.00005, skills: [SkillType.Combat], item: ItemType.Calamari, unlocks_task: 248 }),
