...
export const ZONES: Zone[] = [
    ...
    },
    {
        ...
        tasks: [
            ...
            new TaskDefinition({ id: 282, name: "Train Your Fighters", type: TaskType.Mandatory, cost_multiplier: 1_000_000_000_000_000_000_000_000, max_reps: 2, skills: [SkillType.Study, SkillType.Combat], xp_mult: 0.00000000001 }),
            new TaskDefinition({ id: 283, name: "Train Your Magicians", type: TaskType.Mandatory, cost_multiplier: 1_000_000_000_000_000, max_reps: 3, skills: [SkillType.Study, SkillType.Magic], xp_mult: 0.00001 }),
            new TaskDefinition({ id: 284, name: "PLACEHOLDER", max_reps: 4, cost_multiplier: 200_000_000, skills: [SkillType.Crafting], item: ItemType.MadContraption, xp_mult: 0.01 },),
            ...
            new TaskDefinition({ id: 286, name: "PLACEHOLDER", cost_multiplier: 200_000_000, max_reps: 3, skills: [SkillType.Charisma], xp_mult: 2 }),
            new TaskDefinition({ id: 287, name: "PLACEHOLDER", cost_multiplier: 60_000_000_000_000, max_reps: 9, xp_mult: 0.0002, skills: [SkillType.Study, SkillType.Magic] }),
            new TaskDefinition({ id: 288, name: "PLACEHOLDER", type: TaskType.Boss, cost_multiplier: 1_000_000_000_000, xp_mult: 0.00001, skills: [SkillType.Combat], item: ItemType.Calamari, unlocks_task: 288 }),
            new TaskDefinition({ id: 289, name: "PLACEHOLDER", cost_multiplier: 3_000_000_000_000, xp_mult: 0.0001, skills: [SkillType.Combat, SkillType.Search], perk: PerkType.DragonSlayer,hidden_by_default: true }),
        ],
    },
    {
        ...
        tasks: [
            ...
            new TaskDefinition({ id: 294, name: "PLACEHOLDER", cost_multiplier: 7_000_000_000_000, max_reps: 5, xp_mult: 0.001, skills: [SkillType.Magic], perk: PerkType.DivinePower }),
            new TaskDefinition({ id: 295, name: "PLACEHOLDER", cost_multiplier: 200_000_000, max_reps: 3, skills: [SkillType.Charisma], xp_mult: 2 }),
            new TaskDefinition({ id: 296, name: "PLACEHOLDER", cost_multiplier: 60_000_000_000_000, max_reps: 9, xp_mult: 0.0002, skills: [SkillType.Study, SkillType.Magic] }),
            new TaskDefinition({ id: 297, name: "PLACEHOLDER", type: TaskType.Boss, cost_multiplier: 1_000_000_000_000, xp_mult: 0.00001, skills: [SkillType.Combat], item: ItemType.Calamari, unlocks_task: 298 }),
