...
export const ZONES: Zone[] = [
    ...
    },
    {
        name: "The Foothills",
        tasks: [
            new TaskDefinition({ id: 180, name: "Enter the Dragon's Hoard", type: TaskType.Travel, cost_multiplier: 100, skills: [SkillType.Travel], perk: PerkType.Awakening }),
            new TaskDefinition({ id: 181, name: "Find the Hidden Entrance", type: TaskType.Mandatory, cost_multiplier: 10_000, max_reps: 1, skills: [SkillType.Search], xp_mult: 0.05 }),
            new TaskDefinition({ id: 182, name: "Evade the Dragon", type: TaskType.Mandatory, cost_multiplier: 100, max_reps: 3, skills: [SkillType.Subterfuge], xp_mult: 0.2 }),
