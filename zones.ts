...
export const ZONES: Zone[] = [
    ...
    },
    {
        ...
        tasks: [
            ...
            new TaskDefinition({ id: 24, name: "Sparring", cost_multiplier: 5, max_reps: 4, skills: [SkillType.Combat] }),
    ...
    },
    {
        ...
        tasks: [
            ...
            new TaskDefinition({ id: 127, name: "Horde of Lizardfolk", type: TaskType.Boss, cost_multiplier: 150000, xp_mult: 0.5, skills: [SkillType.Combat], item: ItemType.OracleBones, unlocks_task: 128 }),
    ...
    },
    {
        ...
        tasks: [
            ...
            new TaskDefinition({ id: 137, name: "Giant Sandworm", type: TaskType.Boss, cost_multiplier: 600000, xp_mult: 0.4, skills: [SkillType.Combat], item: ItemType.WormHideCoat, unlocks_task: 138 }),
            new TaskDefinition({ id: 138, name: "Learn to Dance the Worm", cost_multiplier: 600000, xp_mult: 0.1, skills: [SkillType.Study, SkillType.Charisma], perk: PerkType.TheWorm, hidden_by_default: true }),
        ],
    },
    {
        name: "The Oasis",
        tasks: [
            ...
            new TaskDefinition({ id: 147, name: "Sleepy Djinn", type: TaskType.Boss, cost_multiplier: 2000000, xp_mult: 0.3, skills: [SkillType.Combat], item: ItemType.DjinnLamp, unlocks_task: 148 }),
    ...
    },
    {
        ...
        tasks: [
            ...
            new TaskDefinition({ id: 151, name: "Apologize for Stealing Reagents", type: TaskType.Mandatory, cost_multiplier: 150, max_reps: 3, skills: [SkillType.Charisma], xp_mult: 0.2 }),
    ...
    },
    {
        name: "???",
        tasks: [
            new TaskDefinition({ id: 160, name: "PLACEHOLDER", type: TaskType.Travel, cost_multiplier: 60, skills: [SkillType.Travel] }),
            new TaskDefinition({ id: 161, name: "PLACEHOLDER", type: TaskType.Mandatory, cost_multiplier: 150, max_reps: 3, skills: [SkillType.Charisma], xp_mult: 0.2 }),
            ...
            new TaskDefinition({ id: 167, name: "PLACEHOLDER", type: TaskType.Boss, cost_multiplier: 2000000, xp_mult: 0.3, skills: [SkillType.Combat] }),
        ],
    },
]
