...
export const ZONES: Zone[] = [
    ...
    },
    {
        ...
        tasks: [
            ...
            new TaskDefinition({ id: 104, name: "Learn Magical Trance", cost_multiplier: 2, max_reps: 6, xp_mult: 0.2, skills: [SkillType.Magic, SkillType.Study], perk: PerkType.DeepTrance }),
    ...
    },
    {
        ...
        tasks: [
            ...
            new TaskDefinition({ id: 177, name: "PLACEHOLDER", type: TaskType.Boss, cost_multiplier: 750_000_000, xp_mult: 0.125, skills: [SkillType.Combat], item: ItemType.Dreamcatcher }),
        ],
    },
    {
        name: "The Foothills",
        tasks: [
            ...
            new TaskDefinition({ id: 187, name: "Dragon Spawn", type: TaskType.Boss, cost_multiplier: 1_200_000_000, xp_mult: 0.1, skills: [SkillType.Combat], item: ItemType.DragonScale }),
        ],
    },
    {
        ...
        tasks: [
            ...
            new TaskDefinition({ id: 191, name: "PLACEHOLDER", type: TaskType.Mandatory, cost_multiplier: 10_000, max_reps: 1, skills: [SkillType.Search], xp_mult: 0.05 }),
            new TaskDefinition({ id: 192, name: "PLACEHOLDER", type: TaskType.Mandatory, cost_multiplier: 100, max_reps: 3, skills: [SkillType.Subterfuge], xp_mult: 0.2 }),
            new TaskDefinition({ id: 193, name: "PLACEHOLDER", max_reps: 4, cost_multiplier: 500, skills: [SkillType.Search], item: ItemType.KnightlyBoots, xp_mult: 0.5 }),
            new TaskDefinition({ id: 194, name: "PLACEHOLDER", cost_multiplier: 1_000, max_reps: 3, skills: [SkillType.Subterfuge, SkillType.Survival], xp_mult: 0.1, perk: PerkType.HideInPlainSight }),
            new TaskDefinition({ id: 195, name: "PLACEHOLDER", cost_multiplier: 100, max_reps: 5, xp_mult: 5, skills: [SkillType.Travel, SkillType.Survival] }),
            new TaskDefinition({ id: 196, name: "PLACEHOLDER", cost_multiplier: 10000, max_reps: 3, xp_mult: 2, skills: [SkillType.Druid] }),
