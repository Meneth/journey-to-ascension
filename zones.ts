...
export const ZONES: Zone[] = [
    ...
    },
    {
        ...
        tasks: [
            ...
            new TaskDefinition({ id: 237, name: "PLACEHOLDER", type: TaskType.Boss, cost_multiplier: 50_000_000_000, xp_mult: 0.0001, skills: [SkillType.Combat], item: ItemType.DragonScale, unlocks_task: 238 }),
    ...
    },
    {
        ...
        tasks: [
            ...
            new TaskDefinition({ id: 247, name: "Half-Kraken", type: TaskType.Boss, cost_multiplier: 150_000_000_000, xp_mult: 0.00005, skills: [SkillType.Combat], item: ItemType.Calamari, unlocks_task: 248 }),
