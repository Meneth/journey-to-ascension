...
export const ZONES: Zone[] = [
    ...
    },
    {
        ...
        tasks: [
            ...
            new TaskDefinition({ id: 227, name: "PLACEHOLDER", type: TaskType.Boss, cost_multiplier: 1_500_000_000_000_000, xp_mult: 0.0005, skills: [SkillType.Combat], item: ItemType.DragonScale, unlocks_task: 228 }),
    ...
    },
    {
        ...
        tasks: [
            ...
            new TaskDefinition({ id: 237, name: "PLACEHOLDER", type: TaskType.Boss, cost_multiplier: 4_000_000_000_000_000, xp_mult: 0.0003, skills: [SkillType.Combat], item: ItemType.DragonScale, unlocks_task: 238 }),
    ...
    },
    {
        ...
        tasks: [
            ...
            new TaskDefinition({ id: 247, name: "Half-Kraken", type: TaskType.Boss, cost_multiplier: 9_000_000_000_000_000, xp_mult: 0.0005, skills: [SkillType.Combat], item: ItemType.Calamari, unlocks_task: 248 }),
